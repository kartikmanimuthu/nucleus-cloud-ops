...
describe('POST /api/v1/gateway/webhook', () => {
    beforeEach(() => vi.clearAllMocks());

    it('delegates to the gateway service for the "webhook" channel', async () => {
        ...
        expect(handleInbound).toHaveBeenCalledWith('webhook', req);
