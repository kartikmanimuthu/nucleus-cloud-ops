...
import { useCertificateExecutions } from "@/lib/queries/certificates";
...
export function CertificateExecutionsTab({ certificateId }: Props) {
    const { data: executions = [], isLoading, isFetching, refetch } =
        useCertificateExecutions(certificateId);
