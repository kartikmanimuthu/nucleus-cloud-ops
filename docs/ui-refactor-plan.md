...
- **Phase 6** (visual overhaul, D1=full) — IN PROGRESS:
    ...
    - **6c-ext2** ⏭ NEXT — wire PageHeader into the audit page (`components/audit/audit-client-component.tsx` has the same sticky header) + any other feature pages (inventory, right-sizing, knowledge-base). Wire EmptyState into accounts-table/schedules-table/list remaining zero-states.
