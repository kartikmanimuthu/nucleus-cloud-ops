...
- **Phase 6** (visual overhaul, D1=full) — IN PROGRESS:
    ...
    - **6b** ⏭ NEXT — framer-motion subtle page/route transitions (e.g. a `<PageTransition>` wrapper in layout-wrapper, fade/slide on route change). Low-risk, additive.
    - **6c** — refine sidebar/spacing/density, dashboard cards, empty states, consistent table styling.
