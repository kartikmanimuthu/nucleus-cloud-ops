...
| 260331-00a | Fix 7 schedule bugs: duplicate React keys, resourceTypes dedup, day ordering, nextExecution computation, start/end time validation, stats cards filtering, E2E test fix | 2026-03-31 | pending | [260331-00a-fix-7-schedule-bugs-duplicate-react-keys](./quick/260331-00a-fix-7-schedule-bugs-duplicate-react-keys/) |
