        ...
        <div className="flex-1 overflow-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Button variant="ghost" size="sm" onClick={() => router.push(`/agent-ops?tenantId=${tenantId}`)}>
                            ...
                            {tasks.map(task => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => router.push(`/agent-ops/scheduled-tasks/${task.taskId}?tenantId=${tenantId}`)}
                                    >
