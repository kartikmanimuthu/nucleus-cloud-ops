...
export default function ScheduledTaskDetailPage() {
    ...
    const handleDelete = () => withBusy(async () => {
        ...
        router.push(`/agent-ops/scheduled-tasks?tenantId=${tenantId}`)
    })
    ...
    const handleTrigger = () => withBusy(async () => {
        ...
        if (data.runId) router.push(`/agent-ops/${data.runId}?tenantId=${tenantId}`)
    })
        ...
        <div className="flex-1 overflow-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Button variant="ghost" size="sm" onClick={() => router.push(`/agent-ops/scheduled-tasks?tenantId=${tenantId}`)}>
