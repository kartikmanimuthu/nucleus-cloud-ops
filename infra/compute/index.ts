...
const webUiTaskDef = new aws.ecs.TaskDefinition("web-ui-task-def", {
    ...
    containerDefinitions: pulumi.all([
        ...
        environment: [
            ...
            { name: "AGENT_TEMP_BUCKET", value: appBucketN },
            { name: "INVENTORY_BUCKET_NAME", value: appBucketN },
            ...
            { name: "KB_STAGING_BUCKET_NAME", value: appBucketN },
